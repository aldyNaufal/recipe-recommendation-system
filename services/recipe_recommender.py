...
class EnhancedIndonesianRecipeRecommender:
    ...
    def save_model(self, filepath):
        """Menyimpan model dan semua komponen yang diperlukan"""
    ...
    def load_model(self, filepath):
        ...
        self.category_similarity = model_data['category_similarity']
        self.valid_categories = model_data['valid_categories']
